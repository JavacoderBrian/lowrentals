...
He was the justice of the peace. William was one of the first to discover gold in the area.<br /></p>
        ...
        <table style="width=100% height=100%">
          ...
          <tr>
            ...
            <td><input type="text" id="contact" placeholder="10 digit Mobile no."/></td>
          </tr>
          <tr>
            <td><label>Message:</label>
            <textarea id="message" placeholder="Message......."></textarea></td>
          </tr>
          <tr>
            <td></td>
            <td><input type="button" id="submit" value="Send Message"/></td>
          </tr>
        </table>
      </div>
        <!--        <div>
